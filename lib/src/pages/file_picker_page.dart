...
class FilePickerPage extends StatefulWidget {
  FilePickerPage({Key key}) : super(key: key);
...
class _FilePickerPageState extends State<FilePickerPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
        title: const Text('File Picker Ejemplo'),
      ),
      body: Center(
        child: Padding(
              ...
              children: <Widget>[
                ...
                ConstrainedBox(
                  ...
                  child: SwitchListTile.adaptive(
                    title: Text('Seleccionar multiples archivos',
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      RaisedButton(
                        ...
                        child: Text("Eliminar archivos seleccionados"),
                      ),
                    ],
                  ),
                ),
